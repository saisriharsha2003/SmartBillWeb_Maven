...
<html>
  <head>
    ...
    <link
      rel="icon"
      href="<%=request.getContextPath()%>/assets/icon.png"
  ...
  <body>
    <div class="hero">
      ...
      <div class="signup">
        <% int count = (Integer)session.getAttribute("cons_count"); if(count>0)
        { %>
        <div class="container">
          <div class="title" style="font-size: 25px">Add Bill</div>
          <form
            id="my_login_form"
            action="<%=request.getContextPath()%>/AdminAddBill"
            method="post"
          >
        ...
        <div class="container" style="width: 800px">
          ...
          >
            <img
              src="<%=request.getContextPath()%>/assets/smile.webp"
          ...
          <div class="flexcenter" style="text-align: center; margin-top: 20px">
            <p style="font-size: 20px; font-weight: 600; color: black">
              Currently no consumers registered to SmartBill. Kindly comeback
              later.
            </p>
          </div>
          <div class="flexcenter">
            <div class="sbutton" style="width: 100%; padding: 20px">
              <button
                ...
                onclick="window.location.href='${pageContext.request.contextPath}/source/Admin/admin_home.jsp'"
              >
                Back to Home
              </button>
            </div>
