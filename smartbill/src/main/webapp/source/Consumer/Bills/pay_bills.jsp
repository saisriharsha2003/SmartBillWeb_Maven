    ...
    <div class="signup">
        ...
        <div class="container1" style="width: 900px;">
            ...
            <div class="pagination">
                ...
                if (currentPage > 1) {
                %>
                    <a href="${pageContext.request.contextPath}/source/Consumer/Bills/pay_bills.jsp?page=<%= currentPage - 1 %>">&laquo; Previous</a>
                <%
                }
                ...
                %>
                    <a href="${pageContext.request.contextPath}/source/Consumer/Bills/pay_bills.jsp?page=<%= i %>"><%= i %></a>
                <%
                    }
                }
                if (currentPage < totalPages) {
                %>
                    <a href="${pageContext.request.contextPath}/source/Consumer/Bills/pay_bills.jsp?page=<%= currentPage + 1 %>">Next &raquo;</a>
                <%
                }
                %>
            </div>
        ...
        <div class="container">
            ...
            <div class="flexcenter">
                <p style="font-size: 20px; font-weight: 600; margin-top: 20px; margin-bottom: 10px;">Currently no bills are there to pay, come back later.</p>
            </div>
