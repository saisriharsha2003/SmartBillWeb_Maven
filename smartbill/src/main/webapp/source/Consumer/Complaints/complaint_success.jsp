    ...
    <div>
      ...
      <div class="signup">
        <div class="container">
          ...
          <div class="sbutton">
            <button type="submit" id="bButton" value="" style="cursor: pointer;" onclick="window.location='${pageContext.request.contextPath}/source/Consumer/home.jsp';">Back to Home</button>
          </div>
        </div>
      </div>
