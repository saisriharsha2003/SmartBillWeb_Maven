          ...
          <form action="<%= request.getContextPath() %>/PaymentSuccess" method="post" >
            ...
            <div style="display: flex; justify-content:center; margin-top: 10px;">
	       		<div class="sbutton" style="width:50%; padding-right:10px;">
	             		<button id="aButton" style="cursor: pointer" onclick="window.location.href='${pageContext.request.contextPath}/source/Consumer/Bills/bill_details.jsp'">Back to BillDetails</button>
	             </div>
