		...
		<div class="container" style="max-width: 1000px">
	        	...
	        	<div style="display: flex; justify-content:center; margin-top: 10px;">
	       		<div class="sbutton" style="width:50%; padding-right:10px;">
	             	<button type="submit" id="aButton" style="cursor: pointer" onclick = "window.location.href = '${pageContext.request.contextPath}/source/Consumer/home.jsp'" >Back to Home</button>
	             </div>
